// https://www.ai-dio.net?bsc
// https://twitter.com/AIdioToken
// https://t.me/aidio_portal
// https://www.reddit.com/r/aidio/
// https://medium.com/@aidio
// https://github.com/aidiodev

// AIdio stands out as a groundbreaking project for the music industry of the future.
...
contract AIdio is ERC20, Ownable, Pausable {
    ...
    constructor() ERC20("AIdio", "AIdio") payable
    {
        uint256 initialSupply = 1000000000000000 * (10**9);
        address owner = 0xe04Aac5c74034E084F52B947E9D0BE6Bd231403D; // owner wallet
